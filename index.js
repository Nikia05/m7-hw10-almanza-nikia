...
window.onload = function() {
  document.getElementById('notes-area').value = localStorage.getItem("NotesData");
  nameSpan.innerHTML = decodeURIComponent(document.cookie);
...
formEl.onsubmit = function(e) {
  ...
  localStorage.setItem("NotesData", document.getElementById('notes-area').value);
